...
const Card3 = () => {
  return (
    <div  className='mt-10 mb-10'>
                  ...
                  <h1 className='font-poppins font-semibold xs:text-[40px] text-[30px] xs:leading-[53px] leading-[43px] text-gradient2 mb-4 '>#PileForGood</h1>
                  
            
            
               <img className='w-[100%]' src="https://sadsindia.org/wp-content/uploads/2020/04/Snapdeal-PileForGood-SADS-1070x446.jpg" alt="" />
               
               
               <p className='font-bold text-white mt-4 font-serif'>Take part in our campaign #VirtualClassroom and put your old clothes, shirts, pants to good use.</p>
